        ...
        <div class="section pt-1">
            <div class="container mt-3 text-dark">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-1">
                        <label for="">Berikan informasi lebih detail</label>
                        <textarea name="description" class="form-control" rows="5" id="">{{ $data->description }}</textarea>
                    </div>

                    <div class="mb-1">
                        <label for="">Status</label>
                        <select name="status" id="" class="form-control form-custom">
                            <option value="belum" @if ($data->status == 'belum') selected @endif>Belum ditemukan
                            </option>
                            <option value="ditemukan" @if ($data->status == 'ditemukan') selected @endif>Sudah
                                ditemukan
                            </option>
                    ...
                    <img src="{{ asset('storage/item-found/' . $data->image) }}" class="img-fluid rounded-lg"
                        height="150px" alt="...">
