                            ...
                            <div class="card-body text-muted">
                                <div class="row">
                                    <div class="col-2"><img
                                            ...
                                            class="w-100" style="aspect-ratio: 1;border-radius: 50%;margin-top:1px" alt=""></div>
                                    <div class="col-10">
                                ...
                                @if($lost->image !== null)
                                    <div class="text-center px-3">
                                        <img src="{{ asset('storage/lostItems/' . $lost->image) }}" class="w-100 rounded-lg" style="max-height:200px"
                                            alt="">
                                    </div>
                                @endif
                                <div class="text-right">
                                    <a href="https://wa.me/{{$lost->no_tlp}}" class="btn btn-success py-3 mt-2 mb-1"><i
