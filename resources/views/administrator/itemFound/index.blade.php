            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <img src="{{ asset('images/cropper.jpg') }}" class="w-100" alt="">
                        </div>
                </div>
                            ...
                            <table id="datatable" class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Menemukan botol minum di sekitar basemant gedung 5</td>
                                        <td>Basemant Gedung 5</td>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" data-toggle="modal" data-target="#image" class="btn btn-warning m-1">
